...
* Took timestamps using ```TIMESTAMP=$(date +"%Y%m%d_%H%M%S")``` to store rimestamped backups.
* Took backups using mysqldump and tar. mysqldump exports the database into a text file and tar compresses the eentire nfs directory into a .tar.gz file.
